...
import com.radiobase.radiobase.MainActivity
...
import com.tmt.mediaplayer.helpers.NotificationHelper
import com.tmt.mediaplayer.helpers.PreferencesHelper
import com.tmt.mediaplayer.helpers.PreferencesHelper.initPreferences
...
//                    stopForeground(true)
    ...
    private var playerListener: Player.Listener = object : Player.Listener {
        ...
        override fun onIsPlayingChanged(isPlaying: Boolean) {
            ...
            Log.e("Player position service", "" + player.currentPosition)
